...
<body class="body" border="0">
	...
	<FORM METHOD="post" id="frmLogin"
		...
		<table width="592" height="350" border="0" cellpadding="0"
			...
			<tr>
				<td height="272"
					background="${pageContext.request.contextPath}/resources/image/bg2.jpg" style="background-repeat: no-repeat">
					...
					<div class="login">
						<table>
							<tr>
								...
								<td width="130"><input type="text" name="id" required="" maxlength="20"
									size="15"
							...
							<tr>
								...
								<td><input type=password name="password" required="" size="16"
							...
							<tr>
								<td width="200px" align="right" style="padding: 0px 67px 0px; font-size: 11px; color: #666666">
