				  	...
				  	<div class="row mailSetting">
					  	<div class="col-lg-12" align="left">
					  		<table width="100%">
					  			...
					  			<tbody>
						  			<tr>
						  				<td width="10%" class="boldText" align="left">· 사용 여부</td>
						  				<td width="90%" align="left"><input type="checkbox" />사용합니다.</td>
						  			</tr>
						  			<tr>
						  				<td class="boldText">· 응답 기간 설정</td>
						  				<td><input type="radio" /> 제한없음 <input type="radio" /> 기간설정</inptu></td>
						  			</tr>
						  			<tr>
						  				<td class="boldText">· 응답 대상 설정</td>
						  				<td><input type="radio" name="object" />
						  				<span class="blueText">내 주소록에 등록된 사람에게만 응답합니다.</span><br>
						  				<input type="radio" name="object" />모든 메일에 응답합니다.
						  				</td>
						  			</tr>
						  			<tr>
						  				<td class="boldText">메일 제목</td>
						  				<td><input type="text" value="[자동응답 메일입니다]"/></td>
						  			</tr>
						  			<tr>
						  				<td class="boldText">메일 내용</td>
						  				<td><textarea name="" id="" cols="50" rows="10"></textarea></td>
						  			</tr>
						  			<tr>
						  				<td class="boldText">메일 형태</td>
						  				<td><input type="radio" name="form" /> 텍스트 <input type="radio" name="form" /> HTML 사용</td>
						  			</tr>
				  				</tbody>
				  			</table>
				  		</div>
