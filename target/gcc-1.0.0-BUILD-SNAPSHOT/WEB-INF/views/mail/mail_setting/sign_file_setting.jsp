					  		...
					  		<table width="100%">
					  			<thead>
					  				<tr>
						  				...
						  				메일을 보낼 때 아래의 내용을 본문에 첨부합니다.</td>
					  				</tr>
					  			</thead>
					  			<tbody>
						  			<tr>
						  				<td width="10%" class="boldText" align="left"><textarea rows="10" cols="60"></textarea></td>
						  			</tr>
						  			<tr>
						  				<td><input type="checkbox"/> 메일 보낼 때 서명 첨부하기 <input type="button" value="저장"/></td>
						  			</tr>
				  				</tbody>
				  			</table>
				  		</div>
