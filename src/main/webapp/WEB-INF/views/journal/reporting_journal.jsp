            ...
            <table width="897" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td><img src="${pageContext.request.contextPath}/resources/image/imgs/img_work/ic.gif" width="37"
                        ...
                        업무일지 &gt; <font color="3366CC"><strong>보고한업무일지</strong></font></td>
                    <td align="right">
    ...
    <tr>
        <td valign="top">
            ...
            <table width="99%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td height="25">총 업무일지수:<strong><font color="3366CC">[15]</font></strong> / 현재페이지:<strong><font
            ...
            <table width="99%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td width="75%" height="24" bgcolor="E3EEF8" style="padding-left:11pt">제 목</td>
                    <td width="5%" align="center" bgcolor="E3EEF8"> 추신</td>
                    <td width="15%" align="center" bgcolor="E3EEF8"> 작성일</td>
                    <td width="5%" align="center" bgcolor="E3EEF8">첨부</td>
                </tr>

                <tr onMouseOver=this.style.backgroundColor='#FAFAFA' onMouseOut=this.style.backgroundColor=''>
                    <td height="24" style="padding-left:9pt"><a href="JavaScript:FormSend('20170623')">6월 23일 주간
                        업무보고</a></td>
                    <td align="center">
                ...
                <tr>
                    <td height="1" colspan="5" align="center" bgcolor="#DFDFDF"></td>
                </tr>

                <tr onMouseOver=this.style.backgroundColor='#FAFAFA' onMouseOut=this.style.backgroundColor=''>
                    <td height="24" style="padding-left:9pt"><a href="JavaScript:FormSend('20170615')">6월 15일 주간 업무
                        보고</a></td>
                    <td align="center">
                ...
                <tr onMouseOver=this.style.backgroundColor='#FAFAFA' onMouseOut=this.style.backgroundColor=''>
                    <td height="24" style="padding-left:9pt"><a href="JavaScript:FormSend('20170609')">6월 9일 업무 보고</a>
                    </td>
                    <td align="center">
                ...
                <tr onMouseOver=this.style.backgroundColor='#FAFAFA' onMouseOut=this.style.backgroundColor=''>
                    <td height="24" style="padding-left:9pt"><a href="JavaScript:FormSend('20170608')">6월 8일 업무 보고</a>
                    </td>
                    <td align="center">
                ...
                <tr onMouseOver=this.style.backgroundColor='#FAFAFA' onMouseOut=this.style.backgroundColor=''>
                    <td height="24" style="padding-left:9pt"><a href="JavaScript:FormSend('20170607')">6월 7일 업무보고</a>
                    </td>
                    <td align="center">
                ...
                <tr onMouseOver=this.style.backgroundColor='#FAFAFA' onMouseOut=this.style.backgroundColor=''>
                    <td height="24" style="padding-left:9pt"><a href="JavaScript:FormSend('20170605')">6월 5일 업무보고</a>
                    </td>
                    <td align="center">
                ...
                <tr onMouseOver=this.style.backgroundColor='#FAFAFA' onMouseOut=this.style.backgroundColor=''>
                    <td height="24" style="padding-left:9pt"><a href="JavaScript:FormSend('20170602')">6월 2일 주간
                        업무보고 </a></td>
                    <td align="center">
                ...
                <tr onMouseOver=this.style.backgroundColor='#FAFAFA' onMouseOut=this.style.backgroundColor=''>
                    <td height="24" style="padding-left:9pt"><a href="JavaScript:FormSend('20170601')">6월 1일 업무 보고</a>
                    </td>
                    <td align="center">
                ...
                <tr onMouseOver=this.style.backgroundColor='#FAFAFA' onMouseOut=this.style.backgroundColor=''>
                    <td height="24" style="padding-left:9pt"><a href="JavaScript:FormSend('20170531')">5월 31일 업무보고</a>
                    </td>
                    <td align="center">
                ...
                <tr onMouseOver=this.style.backgroundColor='#FAFAFA' onMouseOut=this.style.backgroundColor=''>
                    <td height="24" style="padding-left:9pt"><a href="JavaScript:FormSend('20170530')">5월 30일 업무 보고</a>
                    </td>
                    <td align="center">
                ...
                <tr onMouseOver=this.style.backgroundColor='#FAFAFA' onMouseOut=this.style.backgroundColor=''>
                    <td height="24" style="padding-left:9pt"><a href="JavaScript:FormSend('20170529')">5월 29일 업무 보고</a>
                    </td>
                    <td align="center">
                ...
                <tr onMouseOver=this.style.backgroundColor='#FAFAFA' onMouseOut=this.style.backgroundColor=''>
                    <td height="24" style="padding-left:9pt"><a href="JavaScript:FormSend('20170526')">5월 26일 업무 보고</a>
                    </td>
                    <td align="center">
                ...
                <tr onMouseOver=this.style.backgroundColor='#FAFAFA' onMouseOut=this.style.backgroundColor=''>
                    <td height="24" style="padding-left:9pt"><a href="JavaScript:FormSend('20170524')">5월 24일 업무 보고</a>
                    </td>
                    <td align="center">
                ...
                <tr onMouseOver=this.style.backgroundColor='#FAFAFA' onMouseOut=this.style.backgroundColor=''>
                    <td height="24" style="padding-left:9pt"><a href="JavaScript:FormSend('20170519')">5월 19일 업무 보고</a>
                    </td>
                    <td align="center">
                ...
                <tr onMouseOver=this.style.backgroundColor='#FAFAFA' onMouseOut=this.style.backgroundColor=''>
                    <td height="24" style="padding-left:9pt"><a href="JavaScript:FormSend('20170518')">5월 18일 업무 보고</a>
                    </td>
                    <td align="center">
                ...
                <tr align="center">
                    <td height="30" colspan="5" bgcolor="E3EEF8">[총 <font color="3366CC"><strong>15</strong></font>개 문서]&nbsp;&nbsp;
                        현재페이지: <font color="3366CC"> <strong>[1]</strong></font>/1 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <form method="POST" name="kfk" action="wd_ms_viw.asp">
                    <tr align="right" valign="bottom">
                        <td height="30" colspan="3">
                            <input type=radio name=search value="title" checked>제목
                            <input type="text" name="SearchString" size="20" class="box">
                            <img src="${pageContext.request.contextPath}/resources/image/imgs/bt_sear.gif" width="59"
                                 height="21" border="0" align="absmiddle" style="cursor:hand" onclick="Search_f()">
                        </td>
                    </tr>
                </form>
